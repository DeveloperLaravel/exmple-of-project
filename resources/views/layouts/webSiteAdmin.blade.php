            ...
            <div class="upper-header">
                <div class="container">
                    ...
                    <div class="search-input">
                        ...
                        <form action="{{ URL('website/product/search') }}" method="POST">
                            <input type="hidden" name="_token" value="{{ csrf_token() }}">

                            <input type="text" placeholder="Type and Search" id="name" name="name">
                            <input type="submit">
                        </form>
                    </div>

                    <div class="logo">
                        <a href="#"><img src="{{ asset('publicWebsite/images/logo.png') }}"
                                alt=""></a>
                    </div>
                    <div class="clear"></div>
                ...
                <div class="container">
                    ...
                    <nav id="nav">
                        <ul id="navlist" class="sf-menu clearfix">
                            <li class="current"><a href="{{ url('dashboard') }}">Dashboard</a>
                            </li>
                        ...
                        <div class="col-md-3">
                            <div class="f-about">
                                ...
                                <p class="mb20">We possess within us two minds. So far I have written only of the
                                    conscious mind.We further know that the subconscious has recorded every event. This
                                    is
